...
import SafetyBadge from '@/components/scan/SafetyBadge';
import FarmDetails from '@/components/scan/FarmDetails';
import ChemicalTimeline from '@/components/scan/ChemicalTimeline';
